...
type Serv interface {
	LoadCompetition(ctx context.Context, competition *Competition) error
	FetchCoreCompetition(ctx context.Context) (*Competition, error)
	FetchEntireCompetition(ctx context.Context) (*Competition, error)
...
func (svc *competitionServ) LoadCompetition(ctx context.Context, c *Competition) error {
	var errAgr []error
...
func (svc *competitionServ) FetchCoreCompetition(ctx context.Context) (*Competition, error) {
	fls := false
...
func (svc *competitionServ) FetchEntireCompetition(ctx context.Context) (*Competition, error) {
