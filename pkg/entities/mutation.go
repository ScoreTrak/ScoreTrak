...
func (m *ApiTokenMutation) SetRoleID(s string) {
	m.role_id = &s
}

// RoleID returns the value of the "role_id" field in the mutation.
func (m *ApiTokenMutation) RoleID() (r string, exists bool) {
	v := m.role_id
	if v == nil {
		return
	}
...
// OldRoleID returns the old "role_id" field's value of the ApiToken entity.
// If the ApiToken object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ApiTokenMutation) OldRoleID(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ApiTokenMutation) ResetRoleID() {
	m.role_id = nil
}
...
func (m *ApiTokenMutation) Fields() []string {
	...
	if m.role_id != nil {
		fields = append(fields, apitoken.FieldRoleID)
	}
	if m.expired_at != nil {
...
type CompetitionMutation struct {
	...
	display_name                       *string
	round_duration                     *int
	addround_duration                  *int
	current_round_id                   *string
	viewable_to_public                 *bool
	ignore_incomplete_round_in_scoring *bool
...
func (m *CompetitionMutation) SetRoundDuration(i int) {
	m.round_duration = &i
	m.addround_duration = nil
}

// RoundDuration returns the value of the "round_duration" field in the mutation.
func (m *CompetitionMutation) RoundDuration() (r int, exists bool) {
	v := m.round_duration
	if v == nil {
		return
	}
...
// If the Competition object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CompetitionMutation) OldRoundDuration(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *CompetitionMutation) AddRoundDuration(i int) {
	if m.addround_duration != nil {
		*m.addround_duration += i
	} else {
		m.addround_duration = &i
	}
}
...
func (m *CompetitionMutation) AddedRoundDuration() (r int, exists bool) {
...
func (m *CompetitionMutation) ClearRoundDuration() {
	m.round_duration = nil
	m.addround_duration = nil
	m.clearedFields[competition.FieldRoundDuration] = struct{}{}
}

// RoundDurationCleared returns if the "round_duration" field was cleared in this mutation.
func (m *CompetitionMutation) RoundDurationCleared() bool {
	_, ok := m.clearedFields[competition.FieldRoundDuration]
	return ok
}
...
func (m *CompetitionMutation) ResetRoundDuration() {
	m.round_duration = nil
	m.addround_duration = nil
	delete(m.clearedFields, competition.FieldRoundDuration)
}

// SetCurrentRoundID sets the "current_round_id" field.
func (m *CompetitionMutation) SetCurrentRoundID(s string) {
	m.current_round_id = &s
}

// CurrentRoundID returns the value of the "current_round_id" field in the mutation.
func (m *CompetitionMutation) CurrentRoundID() (r string, exists bool) {
	v := m.current_round_id
	if v == nil {
		return
	}
	return *v, true
...
// OldCurrentRoundID returns the old "current_round_id" field's value of the Competition entity.
// If the Competition object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CompetitionMutation) OldCurrentRoundID(ctx context.Context) (v *string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldCurrentRoundID is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldCurrentRoundID requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldCurrentRoundID: %w", err)
	}
	return oldValue.CurrentRoundID, nil
}

// ClearCurrentRoundID clears the value of the "current_round_id" field.
func (m *CompetitionMutation) ClearCurrentRoundID() {
	m.current_round_id = nil
	m.clearedFields[competition.FieldCurrentRoundID] = struct{}{}
}

// CurrentRoundIDCleared returns if the "current_round_id" field was cleared in this mutation.
func (m *CompetitionMutation) CurrentRoundIDCleared() bool {
	_, ok := m.clearedFields[competition.FieldCurrentRoundID]
	return ok
}

// ResetCurrentRoundID resets all changes to the "current_round_id" field.
func (m *CompetitionMutation) ResetCurrentRoundID() {
	m.current_round_id = nil
	delete(m.clearedFields, competition.FieldCurrentRoundID)
}
...
func (m *CompetitionMutation) SetIgnoreIncompleteRoundInScoring(b bool) {
	m.ignore_incomplete_round_in_scoring = &b
}

// IgnoreIncompleteRoundInScoring returns the value of the "ignore_incomplete_round_in_scoring" field in the mutation.
func (m *CompetitionMutation) IgnoreIncompleteRoundInScoring() (r bool, exists bool) {
	v := m.ignore_incomplete_round_in_scoring
	if v == nil {
		return
	}
	return *v, true
...
// OldIgnoreIncompleteRoundInScoring returns the old "ignore_incomplete_round_in_scoring" field's value of the Competition entity.
// If the Competition object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CompetitionMutation) OldIgnoreIncompleteRoundInScoring(ctx context.Context) (v bool, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldIgnoreIncompleteRoundInScoring is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldIgnoreIncompleteRoundInScoring requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldIgnoreIncompleteRoundInScoring: %w", err)
	}
	return oldValue.IgnoreIncompleteRoundInScoring, nil
}

// ClearIgnoreIncompleteRoundInScoring clears the value of the "ignore_incomplete_round_in_scoring" field.
func (m *CompetitionMutation) ClearIgnoreIncompleteRoundInScoring() {
	m.ignore_incomplete_round_in_scoring = nil
	m.clearedFields[competition.FieldIgnoreIncompleteRoundInScoring] = struct{}{}
}

// IgnoreIncompleteRoundInScoringCleared returns if the "ignore_incomplete_round_in_scoring" field was cleared in this mutation.
func (m *CompetitionMutation) IgnoreIncompleteRoundInScoringCleared() bool {
	_, ok := m.clearedFields[competition.FieldIgnoreIncompleteRoundInScoring]
	return ok
}

// ResetIgnoreIncompleteRoundInScoring resets all changes to the "ignore_incomplete_round_in_scoring" field.
func (m *CompetitionMutation) ResetIgnoreIncompleteRoundInScoring() {
	m.ignore_incomplete_round_in_scoring = nil
	delete(m.clearedFields, competition.FieldIgnoreIncompleteRoundInScoring)
}
...
func (m *CompetitionMutation) Fields() []string {
	...
	if m.current_round_id != nil {
		fields = append(fields, competition.FieldCurrentRoundID)
	}
	if m.viewable_to_public != nil {
		fields = append(fields, competition.FieldViewableToPublic)
	}
	if m.ignore_incomplete_round_in_scoring != nil {
		fields = append(fields, competition.FieldIgnoreIncompleteRoundInScoring)
	}
...
func (m *CompetitionMutation) Field(name string) (ent.Value, bool) {
	...
	case competition.FieldIgnoreIncompleteRoundInScoring:
		return m.IgnoreIncompleteRoundInScoring()
...
func (m *CompetitionMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	...
	case competition.FieldCurrentRoundID:
		return m.OldCurrentRoundID(ctx)
	case competition.FieldViewableToPublic:
		return m.OldViewableToPublic(ctx)
	case competition.FieldIgnoreIncompleteRoundInScoring:
		return m.OldIgnoreIncompleteRoundInScoring(ctx)
	case competition.FieldToBeStartedAt:
...
func (m *CompetitionMutation) SetField(name string, value ent.Value) error {
	...
	case competition.FieldIgnoreIncompleteRoundInScoring:
		...
		m.SetIgnoreIncompleteRoundInScoring(v)
		return nil
	case competition.FieldToBeStartedAt:
		v, ok := value.(time.Time)
		if !ok {
...
func (m *CompetitionMutation) ClearedFields() []string {
	...
	if m.FieldCleared(competition.FieldRoundDuration) {
		fields = append(fields, competition.FieldRoundDuration)
	}
	if m.FieldCleared(competition.FieldCurrentRoundID) {
		fields = append(fields, competition.FieldCurrentRoundID)
	}
	if m.FieldCleared(competition.FieldViewableToPublic) {
		fields = append(fields, competition.FieldViewableToPublic)
	}
	if m.FieldCleared(competition.FieldIgnoreIncompleteRoundInScoring) {
		fields = append(fields, competition.FieldIgnoreIncompleteRoundInScoring)
	}
...
func (m *CompetitionMutation) ClearField(name string) error {
	...
	case competition.FieldUpdateTime:
		...
		return nil
	case competition.FieldRoundDuration:
		m.ClearRoundDuration()
		return nil
	case competition.FieldCurrentRoundID:
		m.ClearCurrentRoundID()
		return nil
	case competition.FieldViewableToPublic:
		m.ClearViewableToPublic()
		return nil
	case competition.FieldIgnoreIncompleteRoundInScoring:
		m.ClearIgnoreIncompleteRoundInScoring()
		return nil
	case competition.FieldToBeStartedAt:
...
func (m *CompetitionMutation) ResetField(name string) error {
	...
	case competition.FieldRoundDuration:
		...
		return nil
	case competition.FieldCurrentRoundID:
		m.ResetCurrentRoundID()
		return nil
	case competition.FieldViewableToPublic:
		m.ResetViewableToPublic()
		return nil
	case competition.FieldIgnoreIncompleteRoundInScoring:
		m.ResetIgnoreIncompleteRoundInScoring()
		return nil
	case competition.FieldToBeStartedAt:
...
func (m *ServiceMutation) SetType(s scorerservice.Service) {
	m._type = &s
}

// GetType returns the value of the "type" field in the mutation.
func (m *ServiceMutation) GetType() (r scorerservice.Service, exists bool) {
	v := m._type
	if v == nil {
		return
	}
...
// If the Service object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ServiceMutation) OldType(ctx context.Context) (v scorerservice.Service, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ServiceMutation) SetField(name string, value ent.Value) error {
	...
	case service.FieldUpdateTime:
		...
		return nil
	case service.FieldType:
		v, ok := value.(scorerservice.Service)
		if !ok {
			return fmt.Errorf("unexpected type %T for field %s", value, name)
		}
		m.SetType(v)
