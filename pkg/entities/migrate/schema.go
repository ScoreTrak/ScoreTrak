...
var (
	...
	CompetitionsColumns = []*schema.Column{
		...
		{Name: "round_duration", Type: field.TypeInt, Nullable: true, Default: 60},
		{Name: "current_round_id", Type: field.TypeString, Nullable: true},
		{Name: "viewable_to_public", Type: field.TypeBool, Nullable: true},
		{Name: "ignore_incomplete_round_in_scoring", Type: field.TypeBool, Nullable: true},
	...
	RoundsColumns = []*schema.Column{
		...
		{Name: "status", Type: field.TypeEnum, Enums: []string{"started", "ongoing", "finished", "incomplete"}, Default: "started"},
