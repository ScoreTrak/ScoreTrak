...
type workerGroupServ struct {
	repo   workergrouprepo.Repo
	p      platform.Platform
	q      queue.WorkerQueue
...
func (svc *workerGroupServ) Redeploy(ctx context.Context, id uuid.UUID) error {
...
func NewWorkerGroupServ(repo workergrouprepo.Repo, plat platform.Platform, q queue.WorkerQueue, config config.Config) Serv {
	return &workerGroupServ{
		repo: repo, p: plat, q: q, Config: config,
	}
}

func (svc *workerGroupServ) Delete(ctx context.Context, id uuid.UUID) error {
...
func (svc *workerGroupServ) GetAll(ctx context.Context) ([]*workergroup.WorkerGroup, error) {
	return svc.repo.GetAll(ctx)
}

func (svc *workerGroupServ) GetByID(ctx context.Context, id uuid.UUID) (*workergroup.WorkerGroup, error) {
	return svc.repo.GetByID(ctx, id)
}

func (svc *workerGroupServ) Store(ctx context.Context, serviceGroup *workergroup.WorkerGroup) error {
...
func (svc *workerGroupServ) Update(ctx context.Context, serviceGroup *workergroup.WorkerGroup) error {
