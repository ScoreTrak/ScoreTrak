...
// WorkerGroup model describes a grouping of services.
type WorkerGroup struct {
	...
	Services []*service.Service `json:"services,omitempty" gorm:"foreignkey:WorkerGroupID; constraint:OnUpdate:RESTRICT,OnDelete:RESTRICT"`
}
...
func (s *WorkerGroup) BeforeSave(tx *gorm.DB) (err error) {
	if s.Name != "" {
...
func (s *WorkerGroup) BeforeCreate(tx *gorm.DB) (err error) {
	if s.Name == "" {
