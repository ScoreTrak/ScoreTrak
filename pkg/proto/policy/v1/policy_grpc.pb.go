...
func (c *policyServiceClient) Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (PolicyService_GetClient, error) {
	stream, err := c.cc.NewStream(ctx, &PolicyService_ServiceDesc.Streams[0], "/pkg.proto.policy.v1.PolicyService/Get", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *policyServiceClient) Update(ctx context.Context, in *UpdateRequest, opts ...grpc.CallOption) (*UpdateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/pkg.proto.policy.v1.PolicyService/Update", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PolicyService_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pkg.proto.policy.v1.PolicyService/Update",
	}
...
var PolicyService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pkg.proto.policy.v1.PolicyService",
	...
	Metadata: "pkg/proto/policy/v1/policy.proto",
}
