...
func (c *serviceServiceClient) GetAll(ctx context.Context, in *GetAllRequest, opts ...grpc.CallOption) (*GetAllResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/pkg.proto.service.v1.ServiceService/GetAll", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceServiceClient) GetByID(ctx context.Context, in *GetByIDRequest, opts ...grpc.CallOption) (*GetByIDResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/pkg.proto.service.v1.ServiceService/GetByID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceServiceClient) Delete(ctx context.Context, in *DeleteRequest, opts ...grpc.CallOption) (*DeleteResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/pkg.proto.service.v1.ServiceService/Delete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceServiceClient) Store(ctx context.Context, in *StoreRequest, opts ...grpc.CallOption) (*StoreResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/pkg.proto.service.v1.ServiceService/Store", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceServiceClient) Update(ctx context.Context, in *UpdateRequest, opts ...grpc.CallOption) (*UpdateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/pkg.proto.service.v1.ServiceService/Update", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceServiceClient) TestService(ctx context.Context, in *TestServiceRequest, opts ...grpc.CallOption) (*TestServiceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/pkg.proto.service.v1.ServiceService/TestService", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ServiceService_GetAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pkg.proto.service.v1.ServiceService/GetAll",
	}
...
func _ServiceService_GetByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pkg.proto.service.v1.ServiceService/GetByID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ServiceService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pkg.proto.service.v1.ServiceService/Delete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ServiceService_Store_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pkg.proto.service.v1.ServiceService/Store",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ServiceService_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pkg.proto.service.v1.ServiceService/Update",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ServiceService_TestService_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pkg.proto.service.v1.ServiceService/TestService",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var ServiceService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pkg.proto.service.v1.ServiceService",
	...
	Metadata: "pkg/proto/service/v1/service.proto",
}
