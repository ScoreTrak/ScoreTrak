...
func DataPreload(db *gorm.DB) {
	...
	db.Exec("INSERT INTO services (id, service_group_id, host_id, name, display_name, points, round_units, round_delay, enabled) VALUES (3, 3, 2, 'ServiceOne', 'host3-service3', 50, 3, 0, true)")
