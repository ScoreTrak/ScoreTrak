...
func (cc *CompetitionCreate) AddServiceIDs(ids ...string) *CompetitionCreate {
	cc.mutation.AddServiceIDs(ids...)
	return cc
}

// AddServices adds the "services" edges to the Service entity.
func (cc *CompetitionCreate) AddServices(s ...*Service) *CompetitionCreate {
...
func (cc *CompetitionCreate) AddReportIDs(ids ...int) *CompetitionCreate {
	cc.mutation.AddReportIDs(ids...)
	return cc
}

// AddReports adds the "reports" edges to the Report entity.
func (cc *CompetitionCreate) AddReports(r ...*Report) *CompetitionCreate {
	ids := make([]int, len(r))
	for i := range r {
		ids[i] = r[i].ID
	}
	return cc.AddReportIDs(ids...)
}

// AddRoundIDs adds the "rounds" edge to the Round entity by IDs.
func (cc *CompetitionCreate) AddRoundIDs(ids ...string) *CompetitionCreate {
	cc.mutation.AddRoundIDs(ids...)
	return cc
}

// AddRounds adds the "rounds" edges to the Round entity.
func (cc *CompetitionCreate) AddRounds(r ...*Round) *CompetitionCreate {
	ids := make([]string, len(r))
	for i := range r {
		ids[i] = r[i].ID
	}
	return cc.AddRoundIDs(ids...)
}
...
func (cc *CompetitionCreate) createSpec() (*Competition, *sqlgraph.CreateSpec) {
	...
	if nodes := cc.mutation.ReportsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
