...
func OutcomeStatusEQ(v OutcomeStatus) predicate.Check {
	return predicate.Check(sql.FieldEQ(FieldOutcomeStatus, v))
}

// OutcomeStatusNEQ applies the NEQ predicate on the "outcome_status" field.
func OutcomeStatusNEQ(v OutcomeStatus) predicate.Check {
	return predicate.Check(sql.FieldNEQ(FieldOutcomeStatus, v))
}

// OutcomeStatusIn applies the In predicate on the "outcome_status" field.
func OutcomeStatusIn(vs ...OutcomeStatus) predicate.Check {
	return predicate.Check(sql.FieldIn(FieldOutcomeStatus, vs...))
}

// OutcomeStatusNotIn applies the NotIn predicate on the "outcome_status" field.
func OutcomeStatusNotIn(vs ...OutcomeStatus) predicate.Check {
	return predicate.Check(sql.FieldNotIn(FieldOutcomeStatus, vs...))
}

// OutcomeStatusIsNil applies the IsNil predicate on the "outcome_status" field.
func OutcomeStatusIsNil() predicate.Check {
	return predicate.Check(sql.FieldIsNull(FieldOutcomeStatus))
}

// OutcomeStatusNotNil applies the NotNil predicate on the "outcome_status" field.
func OutcomeStatusNotNil() predicate.Check {
	return predicate.Check(sql.FieldNotNull(FieldOutcomeStatus))
}

// ProgressStatusEQ applies the EQ predicate on the "progress_status" field.
func ProgressStatusEQ(v ProgressStatus) predicate.Check {
	return predicate.Check(sql.FieldEQ(FieldProgressStatus, v))
}

// ProgressStatusNEQ applies the NEQ predicate on the "progress_status" field.
func ProgressStatusNEQ(v ProgressStatus) predicate.Check {
	return predicate.Check(sql.FieldNEQ(FieldProgressStatus, v))
}

// ProgressStatusIn applies the In predicate on the "progress_status" field.
func ProgressStatusIn(vs ...ProgressStatus) predicate.Check {
	return predicate.Check(sql.FieldIn(FieldProgressStatus, vs...))
}

// ProgressStatusNotIn applies the NotIn predicate on the "progress_status" field.
func ProgressStatusNotIn(vs ...ProgressStatus) predicate.Check {
	return predicate.Check(sql.FieldNotIn(FieldProgressStatus, vs...))
}
