...
func TypeEQ(v scorer.ServiceType) predicate.Service {
	vc := v
	return predicate.Service(sql.FieldEQ(FieldType, vc))
}

// TypeNEQ applies the NEQ predicate on the "type" field.
func TypeNEQ(v scorer.ServiceType) predicate.Service {
	vc := v
	return predicate.Service(sql.FieldNEQ(FieldType, vc))
}

// TypeIn applies the In predicate on the "type" field.
func TypeIn(vs ...scorer.ServiceType) predicate.Service {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func TypeNotIn(vs ...scorer.ServiceType) predicate.Service {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
