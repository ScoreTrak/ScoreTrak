...
func (pq *PropertyQuery) Order(o ...property.Order) *PropertyQuery {
...
func (pq *PropertyQuery) QueryTeam() *TeamQuery {
...
func (pq *PropertyQuery) WithTeam(opts ...func(*TeamQuery)) *PropertyQuery {
	query := (&TeamClient{config: pq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (pq *PropertyQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Property, error) {
	...
	if query := pq.withTeam; query != nil {
		if err := pq.loadTeam(ctx, query, nodes, nil,
			func(n *Property, e *Team) { n.Edges.Team = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
