...
type Check struct {
	...
	OutcomeStatus check.OutcomeStatus `json:"outcome_status,omitempty"`
	// ProgressStatus holds the value of the "progress_status" field.
	ProgressStatus check.ProgressStatus `json:"progress_status,omitempty"`
...
func (*Check) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case check.FieldID, check.FieldLog, check.FieldError, check.FieldOutcomeStatus, check.FieldProgressStatus, check.FieldRoundID, check.FieldHostServiceID:
...
func (c *Check) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", c.OutcomeStatus))
	builder.WriteString(", ")
	builder.WriteString("progress_status=")
	builder.WriteString(fmt.Sprintf("%v", c.ProgressStatus))
	builder.WriteString(", ")
