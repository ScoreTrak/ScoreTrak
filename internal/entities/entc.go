...
var noImmutableSetting = gen.MustParse(gen.NewTemplate("no-immutable-setting").Funcs(funcMap).Parse(`
...
func main() {
	...
	ogent, err := ogent.NewExtension(spec, ogent.Templates(noImmutableSetting))
	if err != nil {
