...
func (*Competition) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case competition.FieldPause, competition.FieldViewableToPublic:
			values[i] = new(sql.NullBool)
		case competition.FieldID, competition.FieldName, competition.FieldDisplayName:
			values[i] = new(sql.NullString)
		case competition.FieldCreateTime, competition.FieldUpdateTime, competition.FieldStartedAt, competition.FieldFinishedAt:
