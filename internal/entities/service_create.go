...
func (sc *ServiceCreate) SetType(st scorer.ServiceType) *ServiceCreate {
...
// SetType sets the "type" field.
func (u *ServiceUpsert) SetType(v scorer.ServiceType) *ServiceUpsert {
...
// SetType sets the "type" field.
func (u *ServiceUpsertOne) SetType(v scorer.ServiceType) *ServiceUpsertOne {
	return u.Update(func(s *ServiceUpsert) {
		s.SetType(v)
	})
}
...
// SetType sets the "type" field.
func (u *ServiceUpsertBulk) SetType(v scorer.ServiceType) *ServiceUpsertBulk {
	return u.Update(func(s *ServiceUpsert) {
		s.SetType(v)
	})
}
