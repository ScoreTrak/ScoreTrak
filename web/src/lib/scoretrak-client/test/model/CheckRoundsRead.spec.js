...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CheckRoundsRead', function() {
      beforeEach(function() {
        instance = new EntSchemaApi.CheckRoundsRead();
      });

      it('should create an instance of CheckRoundsRead', function() {
        // TODO: update the code to test CheckRoundsRead
        expect(instance).to.be.a(EntSchemaApi.CheckRoundsRead);
      });
