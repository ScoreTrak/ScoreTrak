...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CheckCreate', function() {
      beforeEach(function() {
        instance = new EntSchemaApi.CheckCreate();
      });

      it('should create an instance of CheckCreate', function() {
        // TODO: update the code to test CheckCreate
        expect(instance).to.be.a(EntSchemaApi.CheckCreate);
      });
