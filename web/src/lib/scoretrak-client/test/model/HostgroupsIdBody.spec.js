...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('HostgroupsIdBody', function() {
      beforeEach(function() {
        instance = new EntSchemaApi.HostgroupsIdBody();
      });

      it('should create an instance of HostgroupsIdBody', function() {
        // TODO: update the code to test HostgroupsIdBody
        expect(instance).to.be.a(EntSchemaApi.HostgroupsIdBody);
      });
