...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CheckServicesRead', function() {
      beforeEach(function() {
        instance = new EntSchemaApi.CheckServicesRead();
      });

      it('should create an instance of CheckServicesRead', function() {
        // TODO: update the code to test CheckServicesRead
        expect(instance).to.be.a(EntSchemaApi.CheckServicesRead);
      });
