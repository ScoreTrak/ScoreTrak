...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RoundRead', function() {
      beforeEach(function() {
        instance = new EntSchemaApi.RoundRead();
      });

      it('should create an instance of RoundRead', function() {
        // TODO: update the code to test RoundRead
        expect(instance).to.be.a(EntSchemaApi.RoundRead);
      });
