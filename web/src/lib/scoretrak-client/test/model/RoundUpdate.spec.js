...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RoundUpdate', function() {
      beforeEach(function() {
        instance = new EntSchemaApi.RoundUpdate();
      });

      it('should create an instance of RoundUpdate', function() {
        // TODO: update the code to test RoundUpdate
        expect(instance).to.be.a(EntSchemaApi.RoundUpdate);
      });
