...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RoundCompetitionRead', function() {
      beforeEach(function() {
        instance = new EntSchemaApi.RoundCompetitionRead();
      });

      it('should create an instance of RoundCompetitionRead', function() {
        // TODO: update the code to test RoundCompetitionRead
        expect(instance).to.be.a(EntSchemaApi.RoundCompetitionRead);
      });
