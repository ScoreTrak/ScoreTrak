...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('HostServicesList', function() {
      beforeEach(function() {
        instance = new EntSchemaApi.HostServicesList();
      });

      it('should create an instance of HostServicesList', function() {
        // TODO: update the code to test HostServicesList
        expect(instance).to.be.a(EntSchemaApi.HostServicesList);
      });
