...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PropertyUpdate', function() {
      beforeEach(function() {
        instance = new EntSchemaApi.PropertyUpdate();
      });

      it('should create an instance of PropertyUpdate', function() {
        // TODO: update the code to test PropertyUpdate
        expect(instance).to.be.a(EntSchemaApi.PropertyUpdate);
      });
