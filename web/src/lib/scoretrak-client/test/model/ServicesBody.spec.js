...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ServicesBody', function() {
      beforeEach(function() {
        instance = new EntSchemaApi.ServicesBody();
      });

      it('should create an instance of ServicesBody', function() {
        // TODO: update the code to test ServicesBody
        expect(instance).to.be.a(EntSchemaApi.ServicesBody);
      });
