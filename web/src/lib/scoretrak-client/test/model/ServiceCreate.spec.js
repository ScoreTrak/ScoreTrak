...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ServiceCreate', function() {
      beforeEach(function() {
        instance = new EntSchemaApi.ServiceCreate();
      });

      it('should create an instance of ServiceCreate', function() {
        // TODO: update the code to test ServiceCreate
        expect(instance).to.be.a(EntSchemaApi.ServiceCreate);
      });
