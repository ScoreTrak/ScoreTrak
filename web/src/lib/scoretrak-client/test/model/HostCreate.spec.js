...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('HostCreate', function() {
      beforeEach(function() {
        instance = new EntSchemaApi.HostCreate();
      });

      it('should create an instance of HostCreate', function() {
        // TODO: update the code to test HostCreate
        expect(instance).to.be.a(EntSchemaApi.HostCreate);
      });
