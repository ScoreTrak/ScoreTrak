...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CompetitionRead', function() {
      beforeEach(function() {
        instance = new EntSchemaApi.CompetitionRead();
      });

      it('should create an instance of CompetitionRead', function() {
        // TODO: update the code to test CompetitionRead
        expect(instance).to.be.a(EntSchemaApi.CompetitionRead);
      });
