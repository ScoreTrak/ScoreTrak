...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ServiceRead', function() {
      beforeEach(function() {
        instance = new EntSchemaApi.ServiceRead();
      });

      it('should create an instance of ServiceRead', function() {
        // TODO: update the code to test ServiceRead
        expect(instance).to.be.a(EntSchemaApi.ServiceRead);
      });
