...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ServiceTeamRead', function() {
      beforeEach(function() {
        instance = new EntSchemaApi.ServiceTeamRead();
      });

      it('should create an instance of ServiceTeamRead', function() {
        // TODO: update the code to test ServiceTeamRead
        expect(instance).to.be.a(EntSchemaApi.ServiceTeamRead);
      });
