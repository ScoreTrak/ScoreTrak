...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('HostCompetitionRead', function() {
      beforeEach(function() {
        instance = new EntSchemaApi.HostCompetitionRead();
      });

      it('should create an instance of HostCompetitionRead', function() {
        // TODO: update the code to test HostCompetitionRead
        expect(instance).to.be.a(EntSchemaApi.HostCompetitionRead);
      });
