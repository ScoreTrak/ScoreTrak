...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CheckUpdate', function() {
      beforeEach(function() {
        instance = new EntSchemaApi.CheckUpdate();
      });

      it('should create an instance of CheckUpdate', function() {
        // TODO: update the code to test CheckUpdate
        expect(instance).to.be.a(EntSchemaApi.CheckUpdate);
      });
