...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TeamUpdate', function() {
      beforeEach(function() {
        instance = new EntSchemaApi.TeamUpdate();
      });

      it('should create an instance of TeamUpdate', function() {
        // TODO: update the code to test TeamUpdate
        expect(instance).to.be.a(EntSchemaApi.TeamUpdate);
      });
