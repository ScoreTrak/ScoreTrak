...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CompetitionCreate', function() {
      beforeEach(function() {
        instance = new EntSchemaApi.CompetitionCreate();
      });

      it('should create an instance of CompetitionCreate', function() {
        // TODO: update the code to test CompetitionCreate
        expect(instance).to.be.a(EntSchemaApi.CompetitionCreate);
      });
