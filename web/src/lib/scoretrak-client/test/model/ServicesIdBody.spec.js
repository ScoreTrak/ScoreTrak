...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ServicesIdBody', function() {
      beforeEach(function() {
        instance = new EntSchemaApi.ServicesIdBody();
      });

      it('should create an instance of ServicesIdBody', function() {
        // TODO: update the code to test ServicesIdBody
        expect(instance).to.be.a(EntSchemaApi.ServicesIdBody);
      });
      ...
      it('should have the property checks (base name: "checks")', function() {
        // TODO: update the code to test the property checks
        expect(instance).to.have.property('checks');
        // expect(instance.checks).to.be(expectedValueLiteral);
      });
