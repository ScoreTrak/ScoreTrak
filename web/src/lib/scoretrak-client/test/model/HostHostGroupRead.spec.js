...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('HostHostGroupRead', function() {
      beforeEach(function() {
        instance = new EntSchemaApi.HostHostGroupRead();
      });

      it('should create an instance of HostHostGroupRead', function() {
        // TODO: update the code to test HostHostGroupRead
        expect(instance).to.be.a(EntSchemaApi.HostHostGroupRead);
      });
