...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PropertiesIdBody', function() {
      beforeEach(function() {
        instance = new EntSchemaApi.PropertiesIdBody();
      });

      it('should create an instance of PropertiesIdBody', function() {
        // TODO: update the code to test PropertiesIdBody
        expect(instance).to.be.a(EntSchemaApi.PropertiesIdBody);
      });
