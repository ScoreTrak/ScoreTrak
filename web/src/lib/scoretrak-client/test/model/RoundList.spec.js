...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RoundList', function() {
      beforeEach(function() {
        instance = new EntSchemaApi.RoundList();
      });

      it('should create an instance of RoundList', function() {
        // TODO: update the code to test RoundList
        expect(instance).to.be.a(EntSchemaApi.RoundList);
      });
