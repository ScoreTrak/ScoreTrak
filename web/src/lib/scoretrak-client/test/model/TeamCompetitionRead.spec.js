...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TeamCompetitionRead', function() {
      beforeEach(function() {
        instance = new EntSchemaApi.TeamCompetitionRead();
      });

      it('should create an instance of TeamCompetitionRead', function() {
        // TODO: update the code to test TeamCompetitionRead
        expect(instance).to.be.a(EntSchemaApi.TeamCompetitionRead);
      });
