...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PropertyTeamRead', function() {
      beforeEach(function() {
        instance = new EntSchemaApi.PropertyTeamRead();
      });

      it('should create an instance of PropertyTeamRead', function() {
        // TODO: update the code to test PropertyTeamRead
        expect(instance).to.be.a(EntSchemaApi.PropertyTeamRead);
      });
