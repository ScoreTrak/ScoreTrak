...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TeamsIdBody', function() {
      beforeEach(function() {
        instance = new EntSchemaApi.TeamsIdBody();
      });

      it('should create an instance of TeamsIdBody', function() {
        // TODO: update the code to test TeamsIdBody
        expect(instance).to.be.a(EntSchemaApi.TeamsIdBody);
      });
