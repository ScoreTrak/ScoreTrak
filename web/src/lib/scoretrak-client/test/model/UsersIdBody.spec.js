...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UsersIdBody', function() {
      beforeEach(function() {
        instance = new EntSchemaApi.UsersIdBody();
      });

      it('should create an instance of UsersIdBody', function() {
        // TODO: update the code to test UsersIdBody
        expect(instance).to.be.a(EntSchemaApi.UsersIdBody);
      });
