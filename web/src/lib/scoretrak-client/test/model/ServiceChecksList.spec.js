...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ServiceChecksList', function() {
      beforeEach(function() {
        instance = new EntSchemaApi.ServiceChecksList();
      });

      it('should create an instance of ServiceChecksList', function() {
        // TODO: update the code to test ServiceChecksList
        expect(instance).to.be.a(EntSchemaApi.ServiceChecksList);
      });
