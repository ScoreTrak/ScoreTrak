...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('HostGroup', function() {
      beforeEach(function() {
        instance = new EntSchemaApi.HostGroup();
      });

      it('should create an instance of HostGroup', function() {
        // TODO: update the code to test HostGroup
        expect(instance).to.be.a(EntSchemaApi.HostGroup);
      });
