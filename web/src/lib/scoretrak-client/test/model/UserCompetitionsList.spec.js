...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UserCompetitionsList', function() {
      beforeEach(function() {
        instance = new EntSchemaApi.UserCompetitionsList();
      });

      it('should create an instance of UserCompetitionsList', function() {
        // TODO: update the code to test UserCompetitionsList
        expect(instance).to.be.a(EntSchemaApi.UserCompetitionsList);
      });
