...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PropertyServicesRead', function() {
      beforeEach(function() {
        instance = new EntSchemaApi.PropertyServicesRead();
      });

      it('should create an instance of PropertyServicesRead', function() {
        // TODO: update the code to test PropertyServicesRead
        expect(instance).to.be.a(EntSchemaApi.PropertyServicesRead);
      });
      ...
      it('should have the property roundDelay (base name: "round_delay")', function() {
        // TODO: update the code to test the property roundDelay
        expect(instance).to.have.property('roundDelay');
        // expect(instance.roundDelay).to.be(expectedValueLiteral);
      });
