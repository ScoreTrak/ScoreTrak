...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CompetitionsIdBody', function() {
      beforeEach(function() {
        instance = new EntSchemaApi.CompetitionsIdBody();
      });

      it('should create an instance of CompetitionsIdBody', function() {
        // TODO: update the code to test CompetitionsIdBody
        expect(instance).to.be.a(EntSchemaApi.CompetitionsIdBody);
      });
