...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TeamHostsList', function() {
      beforeEach(function() {
        instance = new EntSchemaApi.TeamHostsList();
      });

      it('should create an instance of TeamHostsList', function() {
        // TODO: update the code to test TeamHostsList
        expect(instance).to.be.a(EntSchemaApi.TeamHostsList);
      });
