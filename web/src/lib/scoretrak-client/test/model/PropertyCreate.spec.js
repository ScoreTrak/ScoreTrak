...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PropertyCreate', function() {
      beforeEach(function() {
        instance = new EntSchemaApi.PropertyCreate();
      });

      it('should create an instance of PropertyCreate', function() {
        // TODO: update the code to test PropertyCreate
        expect(instance).to.be.a(EntSchemaApi.PropertyCreate);
      });
