...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ChecksIdBody', function() {
      beforeEach(function() {
        instance = new EntSchemaApi.ChecksIdBody();
      });

      it('should create an instance of ChecksIdBody', function() {
        // TODO: update the code to test ChecksIdBody
        expect(instance).to.be.a(EntSchemaApi.ChecksIdBody);
      });
