...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('HostRead', function() {
      beforeEach(function() {
        instance = new EntSchemaApi.HostRead();
      });

      it('should create an instance of HostRead', function() {
        // TODO: update the code to test HostRead
        expect(instance).to.be.a(EntSchemaApi.HostRead);
      });
