...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PropertyCompetitionRead', function() {
      beforeEach(function() {
        instance = new EntSchemaApi.PropertyCompetitionRead();
      });

      it('should create an instance of PropertyCompetitionRead', function() {
        // TODO: update the code to test PropertyCompetitionRead
        expect(instance).to.be.a(EntSchemaApi.PropertyCompetitionRead);
      });
