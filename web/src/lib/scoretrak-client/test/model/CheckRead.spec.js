...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CheckRead', function() {
      beforeEach(function() {
        instance = new EntSchemaApi.CheckRead();
      });

      it('should create an instance of CheckRead', function() {
        // TODO: update the code to test CheckRead
        expect(instance).to.be.a(EntSchemaApi.CheckRead);
      });
