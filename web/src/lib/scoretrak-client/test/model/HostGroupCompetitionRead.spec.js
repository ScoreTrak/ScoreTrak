...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('HostGroupCompetitionRead', function() {
      beforeEach(function() {
        instance = new EntSchemaApi.HostGroupCompetitionRead();
      });

      it('should create an instance of HostGroupCompetitionRead', function() {
        // TODO: update the code to test HostGroupCompetitionRead
        expect(instance).to.be.a(EntSchemaApi.HostGroupCompetitionRead);
      });
