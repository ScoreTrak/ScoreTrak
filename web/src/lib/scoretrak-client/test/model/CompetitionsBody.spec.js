...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CompetitionsBody', function() {
      beforeEach(function() {
        instance = new EntSchemaApi.CompetitionsBody();
      });

      it('should create an instance of CompetitionsBody', function() {
        // TODO: update the code to test CompetitionsBody
        expect(instance).to.be.a(EntSchemaApi.CompetitionsBody);
      });
