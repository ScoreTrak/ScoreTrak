...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ServiceHostsRead', function() {
      beforeEach(function() {
        instance = new EntSchemaApi.ServiceHostsRead();
      });

      it('should create an instance of ServiceHostsRead', function() {
        // TODO: update the code to test ServiceHostsRead
        expect(instance).to.be.a(EntSchemaApi.ServiceHostsRead);
      });
