...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RoundsBody', function() {
      beforeEach(function() {
        instance = new EntSchemaApi.RoundsBody();
      });

      it('should create an instance of RoundsBody', function() {
        // TODO: update the code to test RoundsBody
        expect(instance).to.be.a(EntSchemaApi.RoundsBody);
      });
