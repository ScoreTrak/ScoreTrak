...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CompetitionList', function() {
      beforeEach(function() {
        instance = new EntSchemaApi.CompetitionList();
      });

      it('should create an instance of CompetitionList', function() {
        // TODO: update the code to test CompetitionList
        expect(instance).to.be.a(EntSchemaApi.CompetitionList);
      });
