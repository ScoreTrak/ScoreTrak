...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PropertyRead', function() {
      beforeEach(function() {
        instance = new EntSchemaApi.PropertyRead();
      });

      it('should create an instance of PropertyRead', function() {
        // TODO: update the code to test PropertyRead
        expect(instance).to.be.a(EntSchemaApi.PropertyRead);
      });
