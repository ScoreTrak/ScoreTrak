...
/**
 * The HostServicesList model module.
 * @module model/HostServicesList
 * @version 0.1.0
 */
export class HostServicesList {
  /**
   * Constructs a new <code>HostServicesList</code>.
   * @alias module:model/HostServicesList
   * @class
   * @param id {Number} 
  ...
  /**
   * Constructs a <code>HostServicesList</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/HostServicesList} obj Optional instance to populate.
   * @return {module:model/HostServicesList} The populated <code>HostServicesList</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new HostServicesList();
 ...
 * @member {Number} id
 */
HostServicesList.prototype.id = undefined;

/**
 * @member {Date} createTime
 */
HostServicesList.prototype.createTime = undefined;

/**
 * @member {Date} updateTime
 */
HostServicesList.prototype.updateTime = undefined;

/**
 * @member {Boolean} pause
 */
HostServicesList.prototype.pause = undefined;

/**
 * @member {Boolean} hidden
 */
HostServicesList.prototype.hidden = undefined;

/**
 * @member {Number} competitionId
 */
HostServicesList.prototype.competitionId = undefined;

/**
 * @member {Number} teamId
 */
HostServicesList.prototype.teamId = undefined;

/**
 * @member {String} name
 */
HostServicesList.prototype.name = undefined;

/**
 * @member {String} displayName
 */
HostServicesList.prototype.displayName = undefined;

/**
 * @member {Number} weight
 */
HostServicesList.prototype.weight = undefined;

/**
 * @member {Number} pointBoost
 */
HostServicesList.prototype.pointBoost = undefined;

/**
 * @member {Number} roundUnits
 */
HostServicesList.prototype.roundUnits = undefined;

/**
 * @member {Number} roundDelay
 */
HostServicesList.prototype.roundDelay = undefined;
