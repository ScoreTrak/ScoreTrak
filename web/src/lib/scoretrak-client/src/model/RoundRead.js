...
/**
 * The RoundRead model module.
 * @module model/RoundRead
 * @version 0.1.0
 */
export class RoundRead {
  /**
   * Constructs a new <code>RoundRead</code>.
   * @alias module:model/RoundRead
   * @class
   * @param id {Number} 
  ...
  /**
   * Constructs a <code>RoundRead</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RoundRead} obj Optional instance to populate.
   * @return {module:model/RoundRead} The populated <code>RoundRead</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new RoundRead();
 ...
 * @member {Number} id
 */
RoundRead.prototype.id = undefined;

/**
 * @member {Date} createTime
 */
RoundRead.prototype.createTime = undefined;

/**
 * @member {Date} updateTime
 */
RoundRead.prototype.updateTime = undefined;

/**
 * @member {Number} competitionId
 */
RoundRead.prototype.competitionId = undefined;

/**
 * @member {Number} roundNumber
 */
RoundRead.prototype.roundNumber = undefined;

/**
 * @member {String} note
 */
RoundRead.prototype.note = undefined;

/**
 * @member {String} err
 */
RoundRead.prototype.err = undefined;

/**
 * @member {Date} startedAt
 */
RoundRead.prototype.startedAt = undefined;

/**
 * @member {Date} finishedAt
 */
RoundRead.prototype.finishedAt = undefined;
