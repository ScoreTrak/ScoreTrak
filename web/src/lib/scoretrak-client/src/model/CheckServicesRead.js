...
/**
 * The CheckServicesRead model module.
 * @module model/CheckServicesRead
 * @version 0.1.0
 */
export class CheckServicesRead {
  /**
   * Constructs a new <code>CheckServicesRead</code>.
   * @alias module:model/CheckServicesRead
   * @class
   * @param id {Number} 
  ...
  /**
   * Constructs a <code>CheckServicesRead</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CheckServicesRead} obj Optional instance to populate.
   * @return {module:model/CheckServicesRead} The populated <code>CheckServicesRead</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new CheckServicesRead();
 ...
 * @member {Number} id
 */
CheckServicesRead.prototype.id = undefined;

/**
 * @member {Date} createTime
 */
CheckServicesRead.prototype.createTime = undefined;

/**
 * @member {Date} updateTime
 */
CheckServicesRead.prototype.updateTime = undefined;

/**
 * @member {Boolean} pause
 */
CheckServicesRead.prototype.pause = undefined;

/**
 * @member {Boolean} hidden
 */
CheckServicesRead.prototype.hidden = undefined;

/**
 * @member {Number} competitionId
 */
CheckServicesRead.prototype.competitionId = undefined;

/**
 * @member {Number} teamId
 */
CheckServicesRead.prototype.teamId = undefined;

/**
 * @member {String} name
 */
CheckServicesRead.prototype.name = undefined;

/**
 * @member {String} displayName
 */
CheckServicesRead.prototype.displayName = undefined;

/**
 * @member {Number} weight
 */
CheckServicesRead.prototype.weight = undefined;

/**
 * @member {Number} pointBoost
 */
CheckServicesRead.prototype.pointBoost = undefined;

/**
 * @member {Number} roundUnits
 */
CheckServicesRead.prototype.roundUnits = undefined;

/**
 * @member {Number} roundDelay
 */
CheckServicesRead.prototype.roundDelay = undefined;
