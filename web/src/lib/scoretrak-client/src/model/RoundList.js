...
/**
 * The RoundList model module.
 * @module model/RoundList
 * @version 0.1.0
 */
export class RoundList {
  /**
   * Constructs a new <code>RoundList</code>.
   * @alias module:model/RoundList
   * @class
   * @param id {Number} 
  ...
  /**
   * Constructs a <code>RoundList</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RoundList} obj Optional instance to populate.
   * @return {module:model/RoundList} The populated <code>RoundList</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new RoundList();
 ...
 * @member {Number} id
 */
RoundList.prototype.id = undefined;

/**
 * @member {Date} createTime
 */
RoundList.prototype.createTime = undefined;

/**
 * @member {Date} updateTime
 */
RoundList.prototype.updateTime = undefined;

/**
 * @member {Number} competitionId
 */
RoundList.prototype.competitionId = undefined;

/**
 * @member {Number} roundNumber
 */
RoundList.prototype.roundNumber = undefined;

/**
 * @member {String} note
 */
RoundList.prototype.note = undefined;

/**
 * @member {String} err
 */
RoundList.prototype.err = undefined;

/**
 * @member {Date} startedAt
 */
RoundList.prototype.startedAt = undefined;

/**
 * @member {Date} finishedAt
 */
RoundList.prototype.finishedAt = undefined;
