...
/**
 * The RoundCreate model module.
 * @module model/RoundCreate
 * @version 0.1.0
 */
export class RoundCreate {
  /**
   * Constructs a new <code>RoundCreate</code>.
   * @alias module:model/RoundCreate
   * @class
   * @param id {Number} 
  ...
  /**
   * Constructs a <code>RoundCreate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RoundCreate} obj Optional instance to populate.
   * @return {module:model/RoundCreate} The populated <code>RoundCreate</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new RoundCreate();
 ...
 * @member {Number} id
 */
RoundCreate.prototype.id = undefined;

/**
 * @member {Date} createTime
 */
RoundCreate.prototype.createTime = undefined;

/**
 * @member {Date} updateTime
 */
RoundCreate.prototype.updateTime = undefined;

/**
 * @member {Number} competitionId
 */
RoundCreate.prototype.competitionId = undefined;

/**
 * @member {Number} roundNumber
 */
RoundCreate.prototype.roundNumber = undefined;

/**
 * @member {String} note
 */
RoundCreate.prototype.note = undefined;

/**
 * @member {String} err
 */
RoundCreate.prototype.err = undefined;

/**
 * @member {Date} startedAt
 */
RoundCreate.prototype.startedAt = undefined;

/**
 * @member {Date} finishedAt
 */
RoundCreate.prototype.finishedAt = undefined;
