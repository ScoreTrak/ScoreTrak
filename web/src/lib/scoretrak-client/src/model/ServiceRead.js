...
/**
 * The ServiceRead model module.
 * @module model/ServiceRead
 * @version 0.1.0
 */
export class ServiceRead {
  /**
   * Constructs a new <code>ServiceRead</code>.
   * @alias module:model/ServiceRead
   * @class
   * @param id {Number} 
  ...
  /**
   * Constructs a <code>ServiceRead</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ServiceRead} obj Optional instance to populate.
   * @return {module:model/ServiceRead} The populated <code>ServiceRead</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new ServiceRead();
 ...
 * @member {Number} id
 */
ServiceRead.prototype.id = undefined;

/**
 * @member {Date} createTime
 */
ServiceRead.prototype.createTime = undefined;

/**
 * @member {Date} updateTime
 */
ServiceRead.prototype.updateTime = undefined;

/**
 * @member {Boolean} pause
 */
ServiceRead.prototype.pause = undefined;

/**
 * @member {Boolean} hidden
 */
ServiceRead.prototype.hidden = undefined;

/**
 * @member {Number} competitionId
 */
ServiceRead.prototype.competitionId = undefined;

/**
 * @member {Number} teamId
 */
ServiceRead.prototype.teamId = undefined;

/**
 * @member {String} name
 */
ServiceRead.prototype.name = undefined;

/**
 * @member {String} displayName
 */
ServiceRead.prototype.displayName = undefined;

/**
 * @member {Number} weight
 */
ServiceRead.prototype.weight = undefined;

/**
 * @member {Number} pointBoost
 */
ServiceRead.prototype.pointBoost = undefined;

/**
 * @member {Number} roundUnits
 */
ServiceRead.prototype.roundUnits = undefined;

/**
 * @member {Number} roundDelay
 */
ServiceRead.prototype.roundDelay = undefined;
