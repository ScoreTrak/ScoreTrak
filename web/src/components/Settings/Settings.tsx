            ...
            reader.onload = function (evt){
                ...
                if (obj.teamsList && obj.teamsList.length !== 0){
                    ...
                    obj.teamsList.forEach(tm => {
                        ...
                        t.setHidden(new BoolValue().setValue(tm.hidden?.value as boolean))
                        t.setEnabled(new BoolValue().setValue(tm.enabled?.value as boolean))
                        teams.push(t)
                    })
                ...
                if (obj.servicesList && obj.servicesList.length !== 0){
                    ...
                    obj.servicesList.forEach(serv => {
                        ...
                        s.setName(serv.name)
                        s.setEnabled(new BoolValue().setValue(serv.enabled?.value as boolean))
