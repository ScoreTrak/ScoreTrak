...
func (as *ActionSuite) Test_Auth_Create() {
	...
	tcases := []struct {
		...
		{u.Username, u.Password, http.StatusFound, "/", "Valid"},
		{"noexist@example.com", "password", http.StatusUnauthorized, "", "Username is Invalid"},
		{u.Username, "invalidPassword", http.StatusUnauthorized, "", "Password Invalid"},
	}
